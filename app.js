...
function renderSkillIcon(skillId = "central-claim", stateName = "unexplored", size = 32) {
  ...
  const icons = {
    "retrieve-explicit": `<svg ${common}><path class="skill-icon-operation" d="M8 8.2 12 12m4-3.8L12 12m0 0-3.8 4.1M12 12l4 4"/><circle class="skill-icon-foundation" cx="8" cy="8.2" r="2.15"/><circle class="skill-icon-foundation" cx="16" cy="8.2" r="2.15"/><circle class="skill-icon-foundation" cx="8.2" cy="16.1" r="2.15"/><circle class="skill-icon-foundation" cx="16" cy="16" r="2.15"/><circle class="skill-icon-accent skill-icon-fill" cx="12" cy="12" r="1.65"/></svg>`,
