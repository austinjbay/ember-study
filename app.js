...
function renderSkillIcon(skillId = "central-claim", stateName = "unexplored", size = 32) {
  ...
  if (key === "retrieve-explicit") {
    return `<svg ${common}>
      ...
      <path class="skill-icon-puzzle-shade" d="M19.1 13.6c.6.1 1.1.6 1.1 1.3v2.5c0 .9-.7 1.6-1.6 1.6h-4.2c-.7 0-1.3-.5-1.5-1.1-.1-.4 0-.8.2-1.1 1.8-.4 3.5-1.2 5-2.3.3-.2.6-.5 1-.9Z"></path>
      <path class="skill-icon-puzzle-sheen" d="M6.6 6.9c1.5-.3 3-.2 4.4.2.3-1.2 1.1-2 2.1-2 .8 0 1.5.5 1.8 1.3 1.3.1 2.4.4 3.3.9-3.8.2-7.3 1.5-10.5 3.9-.7-.7-1.1-1.5-1.2-2.4v-.9c0-.5.1-.8.1-1Z"></path>
      <path class="skill-icon-puzzle-band" d="M6.9 14.2c2.6-4.3 6-7 10.6-8.2l1.8.1c-4.1 1.5-7.3 4.2-9.8 8.3-.9.2-1.8.1-2.6-.2Z"></path>
    </svg>`;
  }
  return `<svg ${common}>
