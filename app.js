...
function renderSkillIcon(skillId = "central-claim", stateName = "unexplored", size = 32) {
  ...
  if (key === "retrieve-explicit") {
    return `<svg ${common}>
      ...
      <path class="skill-icon-puzzle-shade" d="M19.1 13.6c.6.1 1.1.6 1.1 1.3v2.5c0 .9-.7 1.6-1.6 1.6h-4.2c-.7 0-1.3-.5-1.5-1.1-.1-.4 0-.8.2-1.1 1.9-.3 3.5-1.1 5-2.3.3-.2.6-.5 1-.9Z"></path>
      <path class="skill-icon-puzzle-sheen" d="M6.6 6.9c1.5-.3 3-.2 4.4.2.3-1.2 1.1-2 2.1-2 .8 0 1.5.5 1.8 1.3 1.1.1 2.1.4 3 .8-3.4.3-6.5 1.5-9.4 3.5-.8-.6-1.5-1.4-2-2.4v-.4c0-.5.1-.8.1-1Z"></path>
      <path class="skill-icon-puzzle-soft-shadow" d="M9.7 13.6c.5-.4.8-1 .8-1.8s-.3-1.4-.8-1.8c1.2-.6 2.5-1 3.8-1.3-.3.4-.5.9-.5 1.5 0 1.3 1 2.4 2.3 2.5-.7.4-1.5.8-2.3 1.1-1.1.4-2.2.4-3.3-.2Z"></path>
    </svg>`;
  }
  return `<svg ${common}>
