...
function renderSkillIcon(skillId = "central-claim", stateName = "unexplored", size = 32) {
  ...
  if (key === "retrieve-explicit") {
    return `<svg ${common}>
      ...
      <path class="skill-icon-puzzle-sheen" d="M6.6 6.9c1.5-.3 3-.2 4.4.2.3-1.2 1.1-2 2.1-2 .8 0 1.5.5 1.8 1.3 1.3.1 2.4.4 3.3.9-3.9.2-7.5 1.6-10.8 4.1-.6-.8-.9-1.6-.9-2.6v-.9c0-.5.1-.8.1-1Z"></path>
      <path class="skill-icon-puzzle-gloss" d="M7 10.1c2.3-1.7 5-2.7 8.2-2.9"></path>
    </svg>`;
  }
  return `<svg ${common}>
