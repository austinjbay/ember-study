...
function renderSkillIcon(skillId = "central-claim", stateName = "unexplored", size = 32) {
  ...
  if (key === "retrieve-explicit") {
    return `<svg ${common}>
      ...
      <path class="skill-icon-puzzle-edge-light" d="M5.9 8.9v-1.5c0-.5.4-.9.9-.9h3.7c.3-1.3 1.2-2.2 2.4-2.2 1.1 0 2 .9 2.3 2.2h3.3"></path>
      <path class="skill-icon-puzzle-surface-light" d="M6.8 10.3c1.1-.7 2.5-1.2 4.1-1.4.5-.1.9-.3 1.1-.7.3-.5.7-.8 1.2-.8.4 0 .8.2 1.1.5.3.3.7.5 1.1.5h1.8"></path>
      <path class="skill-icon-puzzle-shine-sweep" d="M6.7 12.1c1.5-1.2 3.2-1.9 5.2-2.2.5-.1 1-.3 1.4-.6.4-.3.8-.5 1.3-.5h2.6"></path>
      <path class="skill-icon-puzzle-core-shadow" d="M18.8 12.9c.8.1 1.4.8 1.4 1.6v2.9c0 .9-.7 1.6-1.6 1.6h-4.2c-.7 0-1.3-.5-1.5-1.1-.1-.4 0-.8.2-1.1 2.1-.5 4-1.8 5.3-3.5.1-.1.2-.3.4-.4Z"></path>
      <path class="skill-icon-puzzle-reflected-light" d="M5.2 15.9c1.2.7 2.7.9 4.4.7.1.5.4.9.8 1.2.5.4.8.8.7 1.2h-4.3c-.9 0-1.6-.7-1.6-1.6v-1.5Z"></path>
    </svg>`;
  }
  return `<svg ${common}>
