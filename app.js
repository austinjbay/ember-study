...
function renderSkillIcon(skillId = "central-claim", stateName = "unexplored", size = 32) {
  ...
  if (key === "retrieve-explicit") {
    return `<svg ${common}>
      <defs>
        <radialGradient id="skill-puzzle-bubble" cx="31%" cy="23%" r="78%">
          <stop offset="0" stop-color="#f2c383"></stop>
          <stop offset=".34" stop-color="#c98f4e"></stop>
          <stop offset=".72" stop-color="#a66c36"></stop>
          <stop offset="1" stop-color="#744826"></stop>
        </radialGradient>
      </defs>
      <path class="skill-icon-puzzle-depth" d="M5.7 6.7h3.9c.2-.9.6-1.6 1.1-2 .5-.5 1.1-.7 1.8-.7 1.4 0 2.3 1.1 2.6 2.7h3.3c1.2 0 2.1.9 2.1 2.1v2.5c0 1.1-.8 2-1.8 2.1-.8.1-1.4-.2-1.9-.8-.2-.2-.4-.3-.7-.3-.6 0-1.1.5-1.1 1.2 0 .6.5 1.1 1.1 1.1.3 0 .5-.1.7-.3.5-.6 1.2-.9 1.9-.8 1.1.2 1.8 1.1 1.8 2.1v2c0 1.2-.9 2.1-2.1 2.1h-3.5c-1 0-1.8-.7-2.1-1.6-.2-.8.1-1.5.7-2 .2-.2.4-.5.4-.8 0-.6-.5-1.1-1.1-1.1s-1.1.5-1.1 1.1c0 .3.1.6.4.8.7.5.9 1.3.7 2-.2 1-1.1 1.6-2.1 1.6h-5c-1.2 0-2.1-.9-2.1-2.1v-3.4c0-1 .7-1.9 1.7-2.1.8-.2 1.6.1 2.1.8.2.2.5.4.8.4.6 0 1.1-.5 1.1-1.1s-.5-1.1-1.1-1.1c-.3 0-.6.1-.8.4-.5.6-1.3.9-2.1.8-1-.2-1.7-1-1.7-2.1v-2.8c0-1.2.9-2.1 2.1-2.1Z"></path>
      <path class="skill-icon-puzzle-piece" fill="url(#skill-puzzle-bubble)" d="M5.7 5.9h3.9c.2-.9.6-1.6 1.1-2 .5-.5 1.1-.7 1.8-.7 1.4 0 2.3 1.1 2.6 2.7h3.3c1.2 0 2.1.9 2.1 2.1v2.5c0 1.1-.8 2-1.8 2.1-.8.1-1.4-.2-1.9-.8-.2-.2-.4-.3-.7-.3-.6 0-1.1.5-1.1 1.2 0 .6.5 1.1 1.1 1.1.3 0 .5-.1.7-.3.5-.6 1.2-.9 1.9-.8 1.1.2 1.8 1.1 1.8 2.1v2c0 1.2-.9 2.1-2.1 2.1h-3.5c-1 0-1.8-.7-2.1-1.6-.2-.8.1-1.5.7-2 .2-.2.4-.5.4-.8 0-.6-.5-1.1-1.1-1.1s-1.1.5-1.1 1.1c0 .3.1.6.4.8.7.5.9 1.3.7 2-.2 1-1.1 1.6-2.1 1.6h-5c-1.2 0-2.1-.9-2.1-2.1v-3.4c0-1 .7-1.9 1.7-2.1.8-.2 1.6.1 2.1.8.2.2.5.4.8.4.6 0 1.1-.5 1.1-1.1s-.5-1.1-1.1-1.1c-.3 0-.6.1-.8.4-.5.6-1.3.9-2.1.8-1-.2-1.7-1-1.7-2.1v-2.8c0-1.2.9-2.1 2.1-2.1Z"></path>
      <path class="skill-icon-puzzle-terminator" d="M9.7 13.5c.4-.5.7-1.2.7-1.9s-.2-1.3-.7-1.8c1.7-.5 3.4-.6 5-.3-.4.5-.6 1.1-.6 1.8 0 1.1.7 2 1.7 2.4-2 .7-4.2.6-6.1-.2Z"></path>
      <path class="skill-icon-puzzle-core-shadow" d="M18.2 12.9c1.3 0 2.3.9 2.3 2v2c0 1.2-.9 2.1-2.1 2.1h-3.5c-.9 0-1.7-.6-2-1.4 2.3-.5 4.2-2.1 5.3-4.7Z"></path>
      <path class="skill-icon-puzzle-reflected-light" d="M4.6 15.7c1.5.7 3.2.9 5 .5.1.4.3.7.6 1 .6.5.9 1.1.7 1.8h-5.2c-1.2 0-2.1-.9-2.1-2.1v-.5c0-.6.4-.9 1-.7Z"></path>
    </svg>`;
  }
  return `<svg ${common}>
