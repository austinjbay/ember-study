...
function renderSkillIcon(skillId = "central-claim", stateName = "unexplored", size = 32) {
  ...
  if (key === "retrieve-explicit") {
    return `<svg ${common}>
      ...
      <path class="skill-icon-puzzle-lit-rim" d="M5.9 9.1v-1.7c0-.5.4-.9.9-.9h3.7c.3-1.3 1.2-2.2 2.4-2.2 1.1 0 2 .9 2.3 2.2h3.3"></path>
      <path class="skill-icon-puzzle-half-tone" d="M6.9 10.5c1.3-.8 2.8-1.3 4.4-1.5.4-.1.8-.3 1-.7.3-.5.7-.8 1.2-.8.4 0 .8.2 1.1.5.3.3.7.5 1.1.5h1.5"></path>
