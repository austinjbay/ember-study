...
function renderSkillIcon(skillId = "central-claim", stateName = "unexplored", size = 32) {
  ...
  if (key === "retrieve-explicit") {
    return `<svg ${common}>
      <defs>
        <radialGradient id="skill-puzzle-bubble" cx="34%" cy="24%" r="86%">
          <stop offset="0" stop-color="#f7c889"></stop>
          <stop offset=".35" stop-color="#cf9352"></stop>
          <stop offset=".76" stop-color="#aa713b"></stop>
          <stop offset="1" stop-color="#724627"></stop>
        </radialGradient>
        <linearGradient id="skill-puzzle-glass" x1="5" y1="3.5" x2="15.5" y2="10.5" gradientUnits="userSpaceOnUse">
          <stop offset="0" stop-color="#fffdf7" stop-opacity=".46"></stop>
          <stop offset=".45" stop-color="#fff2cf" stop-opacity=".18"></stop>
          <stop offset="1" stop-color="#fffdf7" stop-opacity=".03"></stop>
        </linearGradient>
        <clipPath id="skill-puzzle-clip">
          <path d="M6.1 5.5c1.1-.3 2.3-.4 3.5-.2.5-1.4 1.5-2.3 2.7-2.3s2.2.9 2.7 2.3c1.1-.2 2.2-.1 3.2.2 1.3 0 2.3 1 2.3 2.3v2.4c0 1-.7 1.9-1.7 2.1-.8.2-1.5-.1-2-.7-.2-.2-.4-.3-.7-.3-.7 0-1.2.5-1.2 1.2s.5 1.2 1.2 1.2c.3 0 .5-.1.7-.3.5-.6 1.3-.9 2-.7 1 .2 1.7 1.1 1.7 2.1v1.9c0 1.3-1 2.3-2.3 2.3h-3.3c-1 0-1.9-.7-2.2-1.7-.2-.8.1-1.5.7-2 .2-.2.3-.5.3-.8 0-.7-.5-1.2-1.2-1.2s-1.2.5-1.2 1.2c0 .3.1.6.4.8.6.5.9 1.3.7 2-.3 1-1.1 1.7-2.2 1.7H6.1c-1.3 0-2.3-1-2.3-2.3v-3.2c0-1 .7-1.9 1.7-2.2.8-.2 1.6.1 2.1.7.2.2.5.4.8.4.7 0 1.2-.5 1.2-1.2s-.5-1.2-1.2-1.2c-.3 0-.6.1-.8.4-.5.6-1.3.9-2.1.7-1-.3-1.7-1.1-1.7-2.2V7.8c0-1.3 1-2.3 2.3-2.3Z"></path>
        </clipPath>
      </defs>
      <path class="skill-icon-puzzle-depth" d="M6.1 6.2c1.1-.3 2.3-.4 3.5-.2.5-1.4 1.5-2.3 2.7-2.3s2.2.9 2.7 2.3c1.1-.2 2.2-.1 3.2.2 1.3 0 2.3 1 2.3 2.3v2.4c0 1-.7 1.9-1.7 2.1-.8.2-1.5-.1-2-.7-.2-.2-.4-.3-.7-.3-.7 0-1.2.5-1.2 1.2s.5 1.2 1.2 1.2c.3 0 .5-.1.7-.3.5-.6 1.3-.9 2-.7 1 .2 1.7 1.1 1.7 2.1v1.9c0 1.3-1 2.3-2.3 2.3h-3.3c-1 0-1.9-.7-2.2-1.7-.2-.8.1-1.5.7-2 .2-.2.3-.5.3-.8 0-.7-.5-1.2-1.2-1.2s-1.2.5-1.2 1.2c0 .3.1.6.4.8.6.5.9 1.3.7 2-.3 1-1.1 1.7-2.2 1.7H6.1c-1.3 0-2.3-1-2.3-2.3v-3.2c0-1 .7-1.9 1.7-2.2.8-.2 1.6.1 2.1.7.2.2.5.4.8.4.7 0 1.2-.5 1.2-1.2s-.5-1.2-1.2-1.2c-.3 0-.6.1-.8.4-.5.6-1.3.9-2.1.7-1-.3-1.7-1.1-1.7-2.2V8.5c0-1.3 1-2.3 2.3-2.3Z"></path>
      <path class="skill-icon-puzzle-piece" fill="url(#skill-puzzle-bubble)" d="M6.1 5.5c1.1-.3 2.3-.4 3.5-.2.5-1.4 1.5-2.3 2.7-2.3s2.2.9 2.7 2.3c1.1-.2 2.2-.1 3.2.2 1.3 0 2.3 1 2.3 2.3v2.4c0 1-.7 1.9-1.7 2.1-.8.2-1.5-.1-2-.7-.2-.2-.4-.3-.7-.3-.7 0-1.2.5-1.2 1.2s.5 1.2 1.2 1.2c.3 0 .5-.1.7-.3.5-.6 1.3-.9 2-.7 1 .2 1.7 1.1 1.7 2.1v1.9c0 1.3-1 2.3-2.3 2.3h-3.3c-1 0-1.9-.7-2.2-1.7-.2-.8.1-1.5.7-2 .2-.2.3-.5.3-.8 0-.7-.5-1.2-1.2-1.2s-1.2.5-1.2 1.2c0 .3.1.6.4.8.6.5.9 1.3.7 2-.3 1-1.1 1.7-2.2 1.7H6.1c-1.3 0-2.3-1-2.3-2.3v-3.2c0-1 .7-1.9 1.7-2.2.8-.2 1.6.1 2.1.7.2.2.5.4.8.4.7 0 1.2-.5 1.2-1.2s-.5-1.2-1.2-1.2c-.3 0-.6.1-.8.4-.5.6-1.3.9-2.1.7-1-.3-1.7-1.1-1.7-2.2V7.8c0-1.3 1-2.3 2.3-2.3Z"></path>
      <ellipse class="skill-icon-puzzle-glass-cap" cx="10.6" cy="6.3" rx="8.4" ry="3.15" clip-path="url(#skill-puzzle-clip)"></ellipse>
      <ellipse class="skill-icon-puzzle-highlight" cx="8.1" cy="6.8" rx="7.1" ry="4.4" clip-path="url(#skill-puzzle-clip)"></ellipse>
      <ellipse class="skill-icon-puzzle-core-shadow" cx="17.8" cy="17.2" rx="7.8" ry="5.5" clip-path="url(#skill-puzzle-clip)"></ellipse>
      <ellipse class="skill-icon-puzzle-reflected-light" cx="6.7" cy="18.8" rx="5.6" ry="2.1" clip-path="url(#skill-puzzle-clip)"></ellipse>
    </svg>`;
  }
  return `<svg ${common}>
