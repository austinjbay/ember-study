...
function renderSkillIcon(skillId = "central-claim", stateName = "unexplored", size = 32) {
  ...
  if (key === "retrieve-explicit") {
    return `<svg ${common}>
      ...
      <path class="skill-icon-puzzle-sheen" d="M6.6 6.7h3.9c.2-1 1-1.8 2-1.8.6 0 1.2.3 1.6.8-2.8.5-5.4 1.7-7.6 3.4v-1.4c0-.6.4-1 1-1Z"></path>
      <path class="skill-icon-puzzle-gloss" d="M6.7 11.5c2.4-1.9 5.4-3 8.7-3.2"></path>
    </svg>`;
  }
  return `<svg ${common}>
