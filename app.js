...
function renderSkillIcon(skillId = "central-claim", stateName = "unexplored", size = 32) {
  ...
  const icons = {
    "retrieve-explicit": `<svg ${common}><circle class="skill-icon-body" cx="7.5" cy="8" r="3"/><circle class="skill-icon-body" cx="16.5" cy="8" r="3"/><circle class="skill-icon-body" cx="8.2" cy="16.2" r="3"/><circle class="skill-icon-body" cx="15.8" cy="16.2" r="3"/><path class="skill-icon-cut" d="M9.6 9.7 12 12l2.4-2.3M9.9 14.5 12 12l2.3 2.5"/><circle class="skill-icon-prize" cx="12" cy="12" r="2"/></svg>`,
    "central-claim": `<svg ${common}><circle class="skill-icon-body" cx="12" cy="12" r="7.2"/><circle class="skill-icon-cut" cx="12" cy="12" r="4"/><circle class="skill-icon-prize" cx="12" cy="12" r="2"/><path class="skill-icon-cut" d="M12 4.8v2M12 17.2v2M4.8 12h2M17.2 12h2"/></svg>`,
    "supporting-ideas": `<svg ${common}><path class="skill-icon-body" d="M5.7 17.8h12.6L15.7 13h-7.4zM8.2 12.2h7.6L13.8 8h-3.6zM10 7.2h4l-2-3z"/><path class="skill-icon-cut" d="M8.6 17.8h6.8M10.1 12.2h3.8"/><circle class="skill-icon-prize" cx="12" cy="8.8" r="1.25"/></svg>`,
    "source-fidelity": `<svg ${common}><path class="skill-icon-body" d="M6.8 5.4h8.4l2.6 2.6v10.6h-11z"/><path class="skill-icon-cut" d="M15.2 5.4v3h3M9.3 11h5M9.3 14h3.4"/><path class="skill-icon-prize" d="m9.4 16.3 1.4 1.2 3.3-4"/></svg>`,
    "connect-ideas": `<svg ${common}><path class="skill-icon-body" d="M7.9 8.1h3.6v3.6H7.9zM12.5 12.4h3.6V16h-3.6z"/><path class="skill-icon-cut" d="M10.7 10.7 13.2 13"/><circle class="skill-icon-prize" cx="7.3" cy="12.7" r="1.35"/><circle class="skill-icon-prize" cx="16.8" cy="7.5" r="1.35"/></svg>`,
    "structure": `<svg ${common}><rect class="skill-icon-body" x="5.6" y="5.5" width="12.8" height="5.1" rx="1.5"/><rect class="skill-icon-body" x="5.6" y="13.4" width="12.8" height="5.1" rx="1.5"/><path class="skill-icon-cut" d="M8.5 8.1h7M8.5 16h4.8M12 10.6v2.8"/><circle class="skill-icon-prize" cx="15.5" cy="16" r="1.2"/></svg>`,
    "point-of-view": `<svg ${common}><path class="skill-icon-body" d="M4.7 12s2.8-5.4 7.3-5.4 7.3 5.4 7.3 5.4-2.8 5.4-7.3 5.4S4.7 12 4.7 12Z"/><circle class="skill-icon-cut-fill" cx="12" cy="12" r="3.1"/><circle class="skill-icon-body" cx="12.8" cy="11.4" r="1.45"/><circle class="skill-icon-prize" cx="16.5" cy="7.6" r="1.1"/></svg>`,
    "match-evidence": `<svg ${common}><path class="skill-icon-body" d="M5.6 6.4h6.3v6.3H5.6zM12.1 11.3h6.3v6.3h-6.3z"/><path class="skill-icon-cut" d="m7.4 9.6 1 1 2.2-2.5M13.9 14.5l1 1 2.2-2.5"/><circle class="skill-icon-prize" cx="12" cy="12" r="1.15"/></svg>`,
    "evaluate-evidence": `<svg ${common}><rect class="skill-icon-body" x="6" y="5.9" width="12" height="12.2" rx="2"/><path class="skill-icon-cut" d="M8.7 9.3h6.6M8.7 12.1h3.9"/><path class="skill-icon-prize" d="m8.6 15.3 1.6 1.4 4.9-5.5"/></svg>`,
    "evaluate-reasoning": `<svg ${common}><path class="skill-icon-body" d="M10.7 5.2h2.6v12.3h-2.6zM6.4 17h11.2v2.2H6.4z"/><path class="skill-icon-body" d="m7.2 8.3-2.4 4.4h4.8zM16.8 8.3l-2.4 4.4h4.8z"/><path class="skill-icon-cut" d="M7.2 8.3h9.6"/><circle class="skill-icon-prize" cx="12" cy="8.3" r="1.25"/></svg>`,
    "build-explanation": `<svg ${common}><path class="skill-icon-body" d="M5.6 17h12.8v2.2H5.6zM7.6 13h8.8v2.4H7.6zM9.7 9h4.6v2.4H9.7zM12 4.5l3.3 3.2H8.7z"/><path class="skill-icon-cut" d="M12 7.7V17"/><circle class="skill-icon-prize" cx="12" cy="13" r="1.15"/></svg>`,
    "infer-implications": `<svg ${common}><path class="skill-icon-body" d="M6.4 14.3 14.3 6.4l3.3 3.3-7.9 7.9H6.4z"/><path class="skill-icon-body" d="M12.2 5.1h6.7v6.7h-2.7V7.8h-4z"/><path class="skill-icon-cut" d="M8 16 16 8"/><circle class="skill-icon-prize" cx="7.1" cy="16.9" r="1.35"/></svg>`,
    "compare-texts": `<svg ${common}><rect class="skill-icon-body" x="5.4" y="6" width="7.3" height="11.5" rx="1.6"/><rect class="skill-icon-body" x="11.3" y="6.6" width="7.3" height="10.9" rx="1.6"/><path class="skill-icon-cut" d="M8 10h2.3M14 10h1.9M8 13.7h2.3M14 13.7h1.9"/><path class="skill-icon-prize" d="M12 7v10.5"/></svg>`,
    "clear-explanations": `<svg ${common}><path class="skill-icon-body" d="M5.2 7.2h13.6v8.2h-4.9L10 18.3l.7-2.9H5.2z"/><path class="skill-icon-cut" d="M8.3 10.2h7.2M8.3 12.9h4.7"/><path class="skill-icon-prize" d="m17 4.8.8 1.7 1.7.8-1.7.8-.8 1.7-.8-1.7-1.7-.8 1.7-.8z"/></svg>`,
    "calibrate-confidence": `<svg ${common}><path class="skill-icon-body" d="M5.4 15.3a6.6 6.6 0 1 1 13.2 0H15c-.3-1.4-1.4-2.3-3-2.3s-2.7.9-3 2.3z"/><path class="skill-icon-cut" d="M8.1 15.1h7.8M12 14l3.1-4.6"/><circle class="skill-icon-prize" cx="12" cy="14" r="1.25"/></svg>`,
    "apply-with-judgment": `<svg ${common}><path class="skill-icon-body" d="m12 4.5 2.2 4.6 5 .7-3.6 3.6.8 5-4.4-2.4-4.4 2.4.8-5-3.6-3.6 5-.7z"/><path class="skill-icon-cut" d="m9.4 12.4 1.6 1.6 3.7-4.1"/><circle class="skill-icon-prize" cx="16.3" cy="17.1" r="1.15"/></svg>`,
    "evaluate-boundaries": `<svg ${common}><path class="skill-icon-body" d="M12 4.8c2.1 1.6 4 2.1 6 2.1v4.8c0 3.6-2.2 6.1-6 7.5-3.8-1.4-6-3.9-6-7.5V6.9c2 0 3.9-.5 6-2.1Z"/><path class="skill-icon-cut" d="M12 7.5v8.8M8.5 12h7"/><path class="skill-icon-prize" d="m8.7 8.7 6.6 6.6"/></svg>`
  };
