...
function renderSkillIcon(skillId = "central-claim", stateName = "unexplored", size = 32) {
  ...
  if (key === "retrieve-explicit") {
    return `<svg ${common}>
      ...
      <path class="skill-icon-puzzle-sheen" d="M6.4 6.7h4.2c.3-1 1.1-1.7 2-1.7.7 0 1.3.3 1.7.9 1.5.1 3 .5 4.3 1.2-4.7.2-8.9 1.8-12.4 4.6v-4c0-.6.4-1 1-1Z"></path>
      <path class="skill-icon-puzzle-gloss" d="M6.7 10.8c2.7-2 6-3.2 9.8-3.4"></path>
      <path class="skill-icon-puzzle-glint" d="M16.8 6.2l.5 1 .9.5-.9.5-.5 1-.5-1-.9-.5.9-.5.5-1Z"></path>
    </svg>`;
  }
  return `<svg ${common}>
