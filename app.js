...
function renderSkillIcon(skillId = "central-claim", stateName = "unexplored", size = 32) {
  ...
  const icons = {
    "retrieve-explicit": `<svg ${common}><path class="skill-icon-body" d="M7.2 6.1c3.1-1.5 6.5-1.5 9.6 0l-1.7 5.2c1.6.8 2.5 2.2 2.5 3.8 0 2.7-2.3 4.7-5.6 4.7s-5.6-2-5.6-4.7c0-1.6.9-3 2.5-3.8z"/><path class="skill-icon-cut" d="M8.8 7.5c2-.8 4.4-.8 6.4 0M9.5 14.8h5"/><circle class="skill-icon-prize" cx="12" cy="11.8" r="1.7"/></svg>`,
    "central-claim": `<svg ${common}><path class="skill-icon-body" d="M5.2 15.9c0-4.1 3.3-8.9 6.8-11.5 3.5 2.6 6.8 7.4 6.8 11.5 0 2.5-2.1 4-6.8 4s-6.8-1.5-6.8-4Z"/><path class="skill-icon-cut" d="M9.1 15.1h5.8M12 7.8v8.7"/><path class="skill-icon-prize" d="m12 7.2 2 2.6-2 2.4-2-2.4z"/></svg>`,
    "supporting-ideas": `<svg ${common}><path class="skill-icon-body" d="M12 4.9c3.9 0 6.6 2.3 6.6 5.8 0 4.6-4.2 7-6.6 8.9-2.4-1.9-6.6-4.3-6.6-8.9 0-3.5 2.7-5.8 6.6-5.8Z"/><path class="skill-icon-cut" d="M12 17.2v-7M8.8 12.3c1.8-.2 3.2.6 3.2 2.1M15.2 12.3c-1.8-.2-3.2.6-3.2 2.1"/><circle class="skill-icon-prize" cx="12" cy="8.7" r="1.3"/></svg>`,
    "source-fidelity": `<svg ${common}><path class="skill-icon-body" d="M12 4.5 18.8 8v5.2c0 3.5-2.5 5.6-6.8 6.8-4.3-1.2-6.8-3.3-6.8-6.8V8z"/><path class="skill-icon-cut" d="M8.6 11.8h6.8M9.8 14.6h4.4"/><path class="skill-icon-prize" d="m9.5 9.2 1.6 1.5 3.6-3.7"/></svg>`,
    "connect-ideas": `<svg ${common}><path class="skill-icon-body" d="M7.2 7.4c2.6-2 7-2 9.6 0 2.3 1.8 2.3 5 0 6.8L12 18.1l-4.8-3.9c-2.3-1.8-2.3-5 0-6.8Z"/><path class="skill-icon-cut" d="M8.7 11.1h2.2l2.2 2.2h2.2M8.9 14h1.8M13.4 10.5h1.8"/><circle class="skill-icon-prize" cx="12" cy="12.4" r="1.2"/></svg>`,
    "structure": `<svg ${common}><path class="skill-icon-body" d="M6.1 6.3c1.3-1 3.7-1.6 5.9-1.6s4.6.6 5.9 1.6v11.4c-1.3 1-3.7 1.6-5.9 1.6s-4.6-.6-5.9-1.6z"/><path class="skill-icon-cut" d="M8.7 8.6c1.9.7 4.7.7 6.6 0M8.7 12c1.9.7 4.7.7 6.6 0M8.7 15.4c1.9.7 4.7.7 6.6 0"/><circle class="skill-icon-prize" cx="16.4" cy="6.4" r="1.2"/></svg>`,
    "point-of-view": `<svg ${common}><path class="skill-icon-body" d="M12 4.7c4.6 0 7 3.2 7 7.3s-2.4 7.3-7 7.3-7-3.2-7-7.3 2.4-7.3 7-7.3Z"/><path class="skill-icon-cut" d="M8.1 11.5c.8-1.2 2-1.9 3.9-1.9s3.1.7 3.9 1.9M9 14.2c1.8 1 4.2 1 6 0"/><circle class="skill-icon-prize" cx="12" cy="12" r="1.6"/></svg>`,
    "match-evidence": `<svg ${common}><path class="skill-icon-body" d="M6.5 7.2h5.7l1.2 2.1h4.1v7.5H6.5z"/><path class="skill-icon-cut" d="M8.6 12.4h3.1M8.6 15h6.8"/><path class="skill-icon-prize" d="m14.2 11.6 1.2 1.2 2.4-2.8"/></svg>`,
    "evaluate-evidence": `<svg ${common}><path class="skill-icon-body" d="M12 5.1c3.4 0 6.2 2.8 6.2 6.2 0 4.1-3.5 5.6-6.2 7.6-2.7-2-6.2-3.5-6.2-7.6 0-3.4 2.8-6.2 6.2-6.2Z"/><path class="skill-icon-cut" d="M8.9 11.2h6.2M9.8 14h4.4"/><path class="skill-icon-prize" d="m9.2 8.8 1.5 1.5 3.8-3.3"/></svg>`,
    "evaluate-reasoning": `<svg ${common}><path class="skill-icon-body" d="M6.2 17.6c.5-5.4 2.4-10.2 5.8-13.2 3.4 3 5.3 7.8 5.8 13.2-3.5 1.6-8.1 1.6-11.6 0Z"/><path class="skill-icon-cut" d="M9.2 16.1c1.6.6 4 .6 5.6 0M12 7.2v6.7M9.6 11.1h4.8"/><circle class="skill-icon-prize" cx="12" cy="7.2" r="1.2"/></svg>`,
    "build-explanation": `<svg ${common}><path class="skill-icon-body" d="M6.4 16.6c.4-3.3 2.4-5.5 5.6-5.5s5.2 2.2 5.6 5.5L12 20z"/><path class="skill-icon-body" d="M8.3 9.5c.3-2.4 1.7-4 3.7-5.2 2 1.2 3.4 2.8 3.7 5.2z"/><path class="skill-icon-cut" d="M9 16.1h6M10 9.4h4M12 10v6"/><circle class="skill-icon-prize" cx="12" cy="13.1" r="1.15"/></svg>`,
    "infer-implications": `<svg ${common}><path class="skill-icon-body" d="M5.5 15.8c3.6-6.4 7.8-9.6 13-10.3-1.3 5.3-4.6 9.4-10.7 13z"/><path class="skill-icon-cut" d="M8.4 15.5 15.3 8.6M13.1 8.1h4.2v4.2"/><circle class="skill-icon-prize" cx="7.2" cy="17.1" r="1.3"/></svg>`,
    "compare-texts": `<svg ${common}><path class="skill-icon-body" d="M7.2 5.7c1.9-1.2 4.3-.8 5.6.9 1.5-1.5 4-1.5 5.5-.1-.3 4.9-2.4 8.4-6.3 11.8-3.9-3.4-6-7-6.3-11.8.5-.3 1-.6 1.5-.8Z"/><path class="skill-icon-cut" d="M12 7.1v9.2M8.7 10.2h2M13.3 10.2h2M8.9 13.6h1.5M13.6 13.6h1.5"/><circle class="skill-icon-prize" cx="12" cy="17.2" r="1"/></svg>`,
    "clear-explanations": `<svg ${common}><path class="skill-icon-body" d="M5.2 7.8c1.9-1.8 11.7-1.8 13.6 0v6.5c-1.4 1.3-4.1 1.7-6 1.8L9.5 19v-3.1c-1.6-.2-3.2-.7-4.3-1.6z"/><path class="skill-icon-cut" d="M8.3 10.2h7.4M8.3 13h5.2"/><circle class="skill-icon-prize" cx="17.1" cy="7.5" r="1.25"/></svg>`,
    "calibrate-confidence": `<svg ${common}><path class="skill-icon-body" d="M12 4.9c4.1 0 7.1 3.1 7.1 6.9 0 3.6-2.8 6.7-7.1 7.3-4.3-.6-7.1-3.7-7.1-7.3 0-3.8 3-6.9 7.1-6.9Z"/><path class="skill-icon-cut" d="M8.4 13.1c1.7-2.2 5.5-2.2 7.2 0M12 13.1l2.4-4.1"/><circle class="skill-icon-prize" cx="12" cy="13.1" r="1.15"/></svg>`,
    "apply-with-judgment": `<svg ${common}><path class="skill-icon-body" d="M12 4.8c4.2 0 7.2 2.8 7.2 6.8 0 4.4-3.4 6.7-7.2 8-3.8-1.3-7.2-3.6-7.2-8 0-4 3-6.8 7.2-6.8Z"/><path class="skill-icon-cut" d="M8.6 12.4 11 14.7l4.7-5.1"/><path class="skill-icon-prize" d="m12 6.8 1 2.1 2.3.3-1.7 1.6.4 2.3-2-1.1-2 1.1.4-2.3-1.7-1.6 2.3-.3z"/></svg>`,
    "evaluate-boundaries": `<svg ${common}><path class="skill-icon-body" d="M12 4.6c4.1 2 6.6 5.3 6.6 9.5-1.6 2.9-3.8 4.7-6.6 5.3-2.8-.6-5-2.4-6.6-5.3 0-4.2 2.5-7.5 6.6-9.5Z"/><path class="skill-icon-cut" d="M12 7.5v8.7M8.7 12h6.6"/><circle class="skill-icon-prize" cx="16.4" cy="8.2" r="1.2"/></svg>`
  };
